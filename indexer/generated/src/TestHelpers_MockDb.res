...
and entities = {
    ...
    @as("MarketFactory_OwnershipTransferred") marketFactory_OwnershipTransferred: entityStoreOperations<Entities.MarketFactory_OwnershipTransferred.t>,
    @as("Prediction") prediction: entityStoreOperations<Entities.Prediction.t>,
    @as("PredictionMarket_MarketCreated") predictionMarket_MarketCreated: entityStoreOperations<Entities.PredictionMarket_MarketCreated.t>,
    @as("PredictionMarket_MarketResolved") predictionMarket_MarketResolved: entityStoreOperations<Entities.PredictionMarket_MarketResolved.t>,
    @as("PredictionMarket_PayoutClaimed") predictionMarket_PayoutClaimed: entityStoreOperations<Entities.PredictionMarket_PayoutClaimed.t>,
    @as("PredictionMarket_PredictionMade") predictionMarket_PredictionMade: entityStoreOperations<Entities.PredictionMarket_PredictionMade.t>,
    @as("ReputationSystem_ReputationUpdated") reputationSystem_ReputationUpdated: entityStoreOperations<Entities.ReputationSystem_ReputationUpdated.t>,
    @as("ReputationSystem_UsernameSet") reputationSystem_UsernameSet: entityStoreOperations<Entities.ReputationSystem_UsernameSet.t>,
  ...
  let entities = {
      ...
      marketFactory_OwnershipTransferred: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketFactory_OwnershipTransferred)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketFactory_OwnershipTransferred.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      prediction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Prediction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Prediction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      predictionMarket_MarketCreated: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PredictionMarket_MarketCreated)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PredictionMarket_MarketCreated.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      predictionMarket_MarketResolved: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PredictionMarket_MarketResolved)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PredictionMarket_MarketResolved.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      predictionMarket_PayoutClaimed: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PredictionMarket_PayoutClaimed)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PredictionMarket_PayoutClaimed.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      predictionMarket_PredictionMade: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PredictionMarket_PredictionMade)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PredictionMarket_PredictionMade.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      reputationSystem_ReputationUpdated: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ReputationSystem_ReputationUpdated)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ReputationSystem_ReputationUpdated.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      reputationSystem_UsernameSet: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ReputationSystem_UsernameSet)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ReputationSystem_UsernameSet.t,
            >
          ),
          ~getKey=({id}) => id,
        )
